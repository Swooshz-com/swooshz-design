...
function sources(): { s6: S6ToS7Handoff; s7: S7ToS8Handoff } {
  const objectBase = {
    ...
    zoneIds: [], requirementIds: [], provenance: { kind: "user_confirmed_design_decision" as const, sourceRef: "test", sourceFingerprint: hashB, acceptedByUser: true, note: null }, unknownIds: [],
  };
  const s6 = {
