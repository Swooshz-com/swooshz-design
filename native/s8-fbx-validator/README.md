...
oriented triangles, exact effective node scales, and effective indexed corner
normals. The production parser depth is 257 nodes: one serialized `SWZ_ROOT`
plus a source hierarchy whose physical depth is capped at 256; root/cardinality
guards reject extra nodes or nodes outside that root. Proprietary
