...
type Candidate = { candidateId: string; candidateIndex: number; status: string; verdict: string; materialFindingIds: string[]; warningFindingIds: string[]; uncertainFindingIds: string[]; requirementObservations: Observation[]; designObservations: Observation[] };
export type S2QaProjection = { qaRun: { id: string; status: string; candidateResults: Candidate[]; repairs: Array<{ candidateId: string; status: string; derivedCandidateId: string | null }>; reQa: Array<{ candidateId: string; status: string; verdict: string }> }; input: { id: string } };
